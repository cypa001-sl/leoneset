...
<div class="container">
  ...
  <span id="printout">
  <h3 align="center">King Bakary</h3>
      <h4 align="center">35 Kingtom Drive<br/>
      Freetown City<br/>
      </h4>
            ...
            <tr>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td>Le <?php echo  $result->PRICE ?></td>
                          <td>Le <output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output></td>
                        </tr>
              <?php
                        }
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  ...
                  <div>Overall Price : Le <?php echo number_format($cur->TOTALPRICE,2); ?></div>
                </div>
              </div>

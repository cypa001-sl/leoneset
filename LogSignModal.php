                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-10">
                                    ...
                                    <button type="submit" id="modalLogin" name="modalLogin" class="btn btn-pup"><span class="glyphicon glyphicon-log-in "></span>   Login</button>
                                     <button class="btn btn-default" data-dismiss="modal" type="button">Close</button><br /><br />
                                     <button><a href="passwordrecover.php"> Forget Password</a></button>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; LeoneSet SL </p>
                        </div>
                    </div>
                  </div>
                  <!-- end login panel -->
                      ...
                      <!-- <h4>Customer Details</h4>  -->
                           ...
                           <form  class="form-horizontal span6" action="customer/controller.php?action=add" onsubmit="return personalInfo();" name="personal" method="POST" enctype="multipart/form-data">
                                <div class="panel panel-pup">
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+232 88180226" type="number" value="">
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of LeoneSet Marketing World.</small>
                                    ...
                                    <div class="panel-footer">
                                        <p align="left">&copy; LeoneSet Marketing World</a></p>
                                    </div>
                            </div>
                            <!-- end panel sign up -->
                        </form>

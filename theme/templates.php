...
<head>
    ...
    <meta name="description" content="For online shopping">
    <meta name="author" content="Group-D">
    <title>Home | LeoneSet Marketing World</title>
    	<link rel="shortcut icon" type="image/jpg" href="images/logo2.jpg">
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +232 75 668-061</a></li>
                <li><a href="www.gmail.com"><i class="fa fa-envelope"></i> leoneset@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo2.jpg" alt="" width="120px" height="100px"/></a>
            </div>
          </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li><a href="<?php web_root?>index.php?q=contact">About Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="companyinfo">
              <h2><span>LeoneSet</span>-Marketing</h2>
              <p>We deliver your taste in everything and produce high value</p>
            </div>
          </div>
          <!--
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#">
                    <iframe class="iframe-img"  src="https://www.youtube.com/watch?v=hLabXhlxaVU"   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </a>
              </div>
            </div>
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>58 Abacha Freetown, Sierra Leone</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-widget">
      <div class="container">
        <p>Feel Free to explore on this section to know more about our services</p>
        <div class="row">
          <div class="col-sm-3">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>Policies</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="cart/terms.php">Terms of Use</a></li>
...
<!--
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-right">&copy; <span>Leoneset</span></p>
        </div>
      </div>
    </div>
  -->

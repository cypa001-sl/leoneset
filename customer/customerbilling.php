...
?>
    ...
    <table>
      <tr>
        ...
        <h3 >LeoneSet Marketing World</h3>
        </td>
      </tr>
    </table>
  ...
  <h5>Your order is on progress. Please be checking your profile for notification of confirmation.</h5>
 ...
 <h4><strong>Order Information</strong></h4>
    ...
    <div class="row">
        ...
        <div class="col-md-6 pull-right">
          <p align="right">Total Price : Le <?php echo number_format($tot,2);?></p>

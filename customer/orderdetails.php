      ...
      <div class="table-responsive cart_info">
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>Le <?php echo  $result->PRODISPRICE ?></td>
                          <td>Le <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   Le <span id="sum">0.00</span></div>
                   <div > Delivery Fee : Le <span id="fee">0.00</span></div>
                   <div> Overall Price : Le <span id="overall"><?php echo $tot ;?></span></div>
                                    ...
                                    <div class="form-group ">
                                      <label>Address where to deliver</label>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          "PLACE">Place(Province/City):</label>

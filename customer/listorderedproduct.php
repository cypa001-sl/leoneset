  ...
  <div class="modal-content">
	<div class="modal-header">
		...
		<table>
			<tr>
				<td align="center">
				<img src="<?php echo web_root; ?>images/home/logo2.png"   alt="Image">
        		</td>
			</tr>
		</table>
...
?>
 	 <h4>Your order has been confirmed and ready for Pick Up</h4><br/>
		<h5>DEAR <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?></h5>
		<h5>As you have ordered cash on delivery, please have the exact amount of cash to pay our staff and bring this billing details.</h5>
		 <hr/>
...
?>
 	 <h4>Your order has been confirmed and delivered</h4><br/>
 		<h5>Dear <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?>,</h5>
		<h5>Your order has been confirmed, thanks for doing business with <b>LeoneSet</b>.	</h5>
		 <hr/>
...
<?php
	...
	echo "<h5>Your order is on progress. Please be checking your profile for notification of confirmation.</h5>";
}
?>
<hr/>
				 ...
				 $subtot=0;
				  $query = "SELECT *
						...
						echo '<tr>';
				  		...
				  		echo '<td> Le'. number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> Le <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td>
				  		<?php
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : Le <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : Le <?php echo number_format($price,2); ?></p>
		  		<p align="right">Overall Price : Le <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
		  ...
		  ?>
		   <hr/>
		  <div class="row">
		 		 <p>Please print this as a proof of your purchased with LeoneSet</p><br/>
		  	  <p>We hope you enjoy your purchased products. Have a nice day!</p>
		  	  <p>Sincerely.</p>
		  	  <h4><a href="#">LeoneSet Marketing World</a></h4>
		  </div>
		  <?php }?>
  </div>
